      ...
      <div className="container-xl lg:container m-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md relative">
            <div className="p-4">
              <div className="mb-6">
                <div className="text-gray-600 my-2">Part-Time</div>
                <h3 className="text-xl font-bold">React Front-End Developer</h3>
              </div>
              ...
              <h3 className="text-indigo-500 mb-2">$60 - $70K / Year</h3>
          ...
          <div className="bg-white rounded-xl shadow-md relative">
            <div className="p-4">
              ...
              <h3 className="text-indigo-500 mb-2">$90K - $100K / Year</h3>
          ...
          <div className="bg-white rounded-xl shadow-md relative">
            <div className="p-4">
              ...
              <h3 className="text-indigo-500 mb-2">$100K - $110K / Year</h3>
